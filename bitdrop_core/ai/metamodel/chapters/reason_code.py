...
# ============================================================
# REASON CODE — MAX CODER REASONING + 3D‑MAX
# ============================================================

class ReasonCode:
    """
    Code‑focused reasoning using deepseek-coder:6.7b (3D‑MAX Edition).
    ...
    def __init__(self, model_name: str = "deepseek-coder:6.7b"):
        ...
        self._last_3d: Optional[ReasonCode3D] = None
