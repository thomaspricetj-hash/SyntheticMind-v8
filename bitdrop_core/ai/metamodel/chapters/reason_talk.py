...
# ============================================================
# REASON TALK — MAX CONVERSATIONAL REASONING + 3D‑MAX
# ============================================================

class ReasonTalk:
    """
    Fast‑path conversational reasoning using phi3:mini (3D‑MAX Edition).
    ...
    def __init__(self, model_name: str = "phi3:mini"):
        ...
        self._last_3d: Optional[ReasonTalk3D] = None
    ...
    def run(self, packet: Packet) -> Dict[str, Any]:
        ...
        try:
            ...
            # ----------------------------------------------------
            # SUCCESSFUL CONVERSATIONAL OUTPUT
            # ----------------------------------------------------
            return {
                "ok": True,
                "model": self.model_name,
