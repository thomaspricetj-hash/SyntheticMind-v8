...
# ============================================================
# REASON GENERAL — MAX GENERAL REASONING + 3D‑MAX
# ============================================================

class ReasonGeneral:
    """
    General reasoning using llama3.1:8b (3D‑MAX Edition).
    ...
    def __init__(self, model_name: str = "llama3.1:8b"):
        ...
        self._last_3d: Optional[ReasonGeneral3D] = None
