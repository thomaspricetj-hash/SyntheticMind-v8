...
# ============================================================
# REASON MATH — MAX MATH & LOGIC REASONING + 3D‑MAX
# ============================================================

class ReasonMath:
    """
    Math and logic reasoning using deepseek-r1:7b (3D‑MAX Edition).
    ...
    def __init__(self, model_name: str = "deepseek-r1:7b"):
        ...
        self._last_3d: Optional[ReasonMath3D] = None
